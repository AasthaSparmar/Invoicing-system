...
<html>
    ...
    <?php
      ...
      <div class="alert alert-success d-flex align-items-center" role="alert" style="opacity:0.8;">
        ...
        <div>
        "Request has been made on the name of '.$name.'. Click here to order:<a href=" http://localhost/phpt/marja/order.php?pid=0&cid='.$cid.'&oid=0">Order</a>
        </div>
      </div>' ;
           }
           else {
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
          <h2><center>Enter Info</center></h2>
            <div class="mb-3">
                ...
                <!--<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Preferably choose from 1000-999999" name="cid">
        -->
